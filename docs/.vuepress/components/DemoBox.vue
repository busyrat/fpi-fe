<template>
  <div
    ...
    <div
      ...
      <!-- <el-tooltip effect="dark" content="前往 jsfiddle.net 运行此示例" placement="right">
        <transition name="text-slide">
          <el-button
...
<script type="text/babel">
  ...
  export default {
    ...
    computed: {
      ...
      blockClass() {
        return `demo-${ this.lang } demo-${ this.$router.currentRoute.path.split('.').splice(-2, 1)[0].split('/').pop() }`;
      },
